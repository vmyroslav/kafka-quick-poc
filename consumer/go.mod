...
require (
	...
	github.com/hellofresh/hfkafka/v2 v2.0.0-alpha.1
...
require (
	...
	github.com/hellofresh/outbox-client-go/v2 v2.0.0-Pre5 // indirect
	github.com/hellofresh/platform-lab v0.8.2 // indirect
